...
{
    using System;
    partial class User : SnQMenu.Contracts.Persistence.Account.IUser
    {
        static User()
        {
            ClassConstructing();
        ...
        {
            if (obj is not SnQMenu.Contracts.Persistence.Account.IUser instance)
            {
                return false;
            }
            return base.Equals(instance) && Equals(instance);
        }
        protected bool Equals(SnQMenu.Contracts.Persistence.Account.IUser other)
        {
            if (other == null)
            {
                return false;
