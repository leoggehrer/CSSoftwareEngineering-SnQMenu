...
{
    using System;
    partial class Identity : SnQMenu.Contracts.Persistence.Account.IIdentity
    {
        static Identity()
        {
            ClassConstructing();
        ...
        public void CopyProperties(SnQMenu.Contracts.Persistence.Account.IIdentity other)
        {
            if (other == null)
            {
        ...
        partial void BeforeCopyProperties(SnQMenu.Contracts.Persistence.Account.IIdentity other, ref bool handled);
        partial void AfterCopyProperties(SnQMenu.Contracts.Persistence.Account.IIdentity other);
        public override bool Equals(object obj)
        {
            if (obj is not SnQMenu.Contracts.Persistence.Account.IIdentity instance)
            {
                return false;
            }
            return base.Equals(instance) && Equals(instance);
        }
        protected bool Equals(SnQMenu.Contracts.Persistence.Account.IIdentity other)
        {
            if (other == null)
            {
                return false;
        ...
        public static Persistence.Account.Identity Create(SnQMenu.Contracts.Persistence.Account.IIdentity other)
        {
            BeforeCreate(other);
            var result = new Persistence.Account.Identity();
        ...
        static partial void BeforeCreate(SnQMenu.Contracts.Persistence.Account.IIdentity other);
        static partial void AfterCreate(Persistence.Account.Identity instance, SnQMenu.Contracts.Persistence.Account.IIdentity other);
    }
}
