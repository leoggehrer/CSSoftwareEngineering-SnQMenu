...
{
    using System;
    partial class LoginSession : SnQMenu.Contracts.Persistence.Account.ILoginSession
    {
        static LoginSession()
        {
            ClassConstructing();
        ...
        public void CopyProperties(SnQMenu.Contracts.Persistence.Account.ILoginSession other)
        {
            if (other == null)
            {
        ...
        partial void BeforeCopyProperties(SnQMenu.Contracts.Persistence.Account.ILoginSession other, ref bool handled);
        partial void AfterCopyProperties(SnQMenu.Contracts.Persistence.Account.ILoginSession other);
        public override bool Equals(object obj)
        {
            if (obj is not SnQMenu.Contracts.Persistence.Account.ILoginSession instance)
            {
                return false;
            }
            return base.Equals(instance) && Equals(instance);
        }
        protected bool Equals(SnQMenu.Contracts.Persistence.Account.ILoginSession other)
        {
            if (other == null)
            {
                return false;
        ...
        public static Persistence.Account.LoginSession Create(SnQMenu.Contracts.Persistence.Account.ILoginSession other)
        {
            BeforeCreate(other);
            var result = new Persistence.Account.LoginSession();
        ...
        static partial void BeforeCreate(SnQMenu.Contracts.Persistence.Account.ILoginSession other);
        static partial void AfterCreate(Persistence.Account.LoginSession instance, SnQMenu.Contracts.Persistence.Account.ILoginSession other);
    }
}
