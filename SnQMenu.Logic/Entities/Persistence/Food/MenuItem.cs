...
{
    using System;
    partial class MenuItem : SnQMenu.Contracts.Persistence.Food.IMenuItem
    {
        static MenuItem()
        {
            ClassConstructing();
        ...
        {
            if (obj is not SnQMenu.Contracts.Persistence.Food.IMenuItem instance)
            {
                return false;
            }
            return base.Equals(instance) && Equals(instance);
        }
        protected bool Equals(SnQMenu.Contracts.Persistence.Food.IMenuItem other)
        {
            if (other == null)
            {
                return false;
            ...
            && IsEqualsWith(InternalName, other.InternalName)
            && IsEqualsWith(AllergenType, other.AllergenType)
            && Price == other.Price
            && SortOrder == other.SortOrder
            && State == other.State;
        }
        ...
        {
            return HashCode.Combine(Name, Description, MenuSectionId, Guid, ImageUrl, InternalName, HashCode.Combine(AllergenType, Price, SortOrder, State));
        }
