...
{
    using System;
    partial class Menu : SnQMenu.Contracts.Persistence.Food.IMenu
    {
        static Menu()
        {
            ClassConstructing();
        ...
        {
            if (obj is not SnQMenu.Contracts.Persistence.Food.IMenu instance)
            {
                return false;
            }
            return base.Equals(instance) && Equals(instance);
        }
        protected bool Equals(SnQMenu.Contracts.Persistence.Food.IMenu other)
        {
            if (other == null)
            {
                return false;
        ...
        {
            return HashCode.Combine(RestaurantId, Guid, From, To, Notes, LanguageCode, HashCode.Combine(State));
        }
